        ...
        <div className="absolute top-0 left-0 w-full p-4 z-30 flex flex-col gap-2 pointer-events-none">
          <div className="flex justify-between items-center w-full max-w-7xl mx-auto">
            ...
            <div className="flex gap-4 items-center">
              ...
              <div className="bg-[#1c1e1c]/90 backdrop-blur-md px-6 py-4 md:px-8 md:py-5 rounded-3xl border border-white/10 flex flex-col items-center gap-1 shadow-2xl">
                <span className="text-sm md:text-base font-bold text-gray-400 uppercase tracking-widest">Koin</span>
                <span className="text-4xl md:text-5xl font-black text-[#d4ff00]">{coins}</span>
              </div>
              <div className="bg-[#1c1e1c]/90 backdrop-blur-md px-6 py-4 md:px-8 md:py-5 rounded-3xl border border-white/10 flex flex-col items-center gap-1 shadow-2xl">
          ...
          <div className="flex justify-between items-center mb-12">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <h1 className="text-2xl md:text-3xl font-bold tracking-tight">Endless Runner</h1>
              </div>
            </div>
          ...
          <div className="flex flex-col md:flex-row gap-12 lg:gap-20">
            ...
            <div className="flex-[1.2] flex flex-col gap-10">
              ...
              <div className="mt-2">
                ...
                <div className="grid grid-cols-2 gap-5">
                  <div className={`rounded-3xl p-6 border-2 transition-all hover:-translate-y-1 ${isLightMode ? 'bg-white border-slate-200 shadow-[0_6px_0_0_#e2e8f0] hover:shadow-[0_8px_0_0_#10b981] hover:border-emerald-500 text-slate-800' : 'bg-[#1c1e1c] border-[#2a2d2a] shadow-[0_6px_0_0_#2a2d2a] hover:shadow-[0_8px_0_0_#9bb800] hover:border-[#d4ff00]'}`}>
                    ...
                    <p className={`text-xl mt-3 ${isLightMode ? 'text-slate-500' : 'text-[#a0a0a0]'}`}>Lompat ke atas secara fisik</p>
                  </div>
                  <div className={`rounded-3xl p-6 border-2 transition-all hover:-translate-y-1 ${isLightMode ? 'bg-white border-slate-200 shadow-[0_6px_0_0_#e2e8f0] hover:shadow-[0_8px_0_0_#10b981] hover:border-emerald-500 text-slate-800' : 'bg-[#1c1e1c] border-[#2a2d2a] shadow-[0_6px_0_0_#2a2d2a] hover:shadow-[0_8px_0_0_#9bb800] hover:border-[#d4ff00]'}`}>
                    ...
                    <p className={`text-xl mt-3 ${isLightMode ? 'text-slate-500' : 'text-[#a0a0a0]'}`}>Jongkok ke bawah secara fisik</p>
                  </div>
                  <div className={`rounded-3xl p-6 border-2 transition-all hover:-translate-y-1 ${isLightMode ? 'bg-white border-slate-200 shadow-[0_6px_0_0_#e2e8f0] hover:shadow-[0_8px_0_0_#10b981] hover:border-emerald-500 text-slate-800' : 'bg-[#1c1e1c] border-[#2a2d2a] shadow-[0_6px_0_0_#2a2d2a] hover:shadow-[0_8px_0_0_#9bb800] hover:border-[#d4ff00]'} col-span-2 flex items-center gap-6`}>
                    ...
                    <div>
                      ...
                      <p className={`text-xl mt-3 ${isLightMode ? 'text-slate-500' : 'text-[#a0a0a0]'}`}>Geser tubuh ke kiri atau kanan kamera</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="flex-1 flex flex-col">
              <div className="flex justify-between items-end mb-6 mt-12 md:mt-0">
                <h3 className="text-2xl font-bold">Pelari Terbaik</h3>
                <span className={`cursor-pointer transition-colors font-medium ${isLightMode ? 'text-emerald-600 hover:text-emerald-800' : 'text-[#a0a0a0] hover:text-white'}`}>Lihat Semua</span>
              </div>
          ...
          <div className={`fixed bottom-0 left-0 w-full p-6 md:p-8 bg-gradient-to-t ${isLightMode ? 'from-slate-50 via-slate-50' : 'from-[#0a0d0c] via-[#0a0d0c]'} to-transparent z-40 pointer-events-none`}>
            <div className="w-full px-6 md:px-12 mx-auto flex items-center justify-between gap-6 pointer-events-auto">
               ...
               <button
                  ...
                  className={`flex-1 h-20 rounded-full flex items-center justify-center gap-4 text-2xl font-black tracking-widest transition-all ${!playerName.trim() ? isLightMode ? 'bg-white text-slate-400 cursor-not-allowed border-2 border-slate-200 shadow-[0_6px_0_0_#e2e8f0]' : 'bg-[#1c1e1c] text-[#555] cursor-not-allowed border-2 border-[#2a2d2a] shadow-[0_6px_0_0_#2a2d2a]' : (isLightMode ? 'bg-emerald-500 text-white hover:bg-emerald-600 border-2 border-emerald-600 shadow-[0_8px_0_0_#047857] hover:-translate-y-1 hover:shadow-[0_10px_0_0_#047857] active:translate-y-[8px] active:shadow-none' : 'bg-[#d4ff00] text-black hover:bg-[#b0d600] border-2 border-[#9bb800] shadow-[0_8px_0_0_#9bb800] hover:-translate-y-1 hover:shadow-[0_10px_0_0_#9bb800] active:translate-y-[8px] active:shadow-none')}`}
                >
          ...
          {!isGameActive && !isGameOver && (
            <div className="absolute inset-0 z-40 flex items-center justify-center bg-black/60 backdrop-blur-sm pointer-events-none">
              <div className="text-center animate-bounce">
                ...
                <p className="text-2xl text-white font-bold bg-black/60 px-8 py-3 rounded-full border-2 border-[#d4ff00]">Tekan SPASI untuk memulai game</p>
              </div>
            </div>
          )}
